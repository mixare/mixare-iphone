...
*/
CV_EXPORT GLenum CVOpenGLESTextureGetTarget( CVOpenGLESTextureRef image) __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_5_0);
...
*/
CV_EXPORT GLuint CVOpenGLESTextureGetName( CVOpenGLESTextureRef image) __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_5_0);
...
*/
CV_EXPORT Boolean CVOpenGLESTextureIsFlipped( CVOpenGLESTextureRef image) __OSX_AVAILABLE_STARTING(__MAC_NA,__IPHONE_5_0);
...
*/
CV_EXPORT void CVOpenGLESTextureGetCleanTexCoords( CVOpenGLESTextureRef image, 
                                                   GLfloat lowerLeft[2], 
