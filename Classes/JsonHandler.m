...
-(NSMutableArray*)processWikipediaJSONData: (NSString*) jsonData{
	...
	for(NSDictionary *geoname in geonames){
		...
		[ret addObject:[NSDictionary dictionaryWithObjectsAndKeys:[geoname objectForKey:@"title"],kTitleKey, [geoname objectForKey:@"summary"],kSummaryKey,[geoname objectForKey:@"wikipediaUrl"],kUrlKey,[geoname objectForKey:@"lng"],kLonKey,[geoname objectForKey:@"lat"],kLatKey,[geoname objectForKey:@"elevation"],kAltKey, @"WIKIPEDIA",kSourceKey, nil]];
	}
	return ret;
}
